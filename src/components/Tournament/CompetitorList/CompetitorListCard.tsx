            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-gray-100 text-xs font-medium text-gray-700">
                  {competitors?.competitorDetailDTO.length}
                </span>
                <span>
                  Tổng số: {competitors?.competitorDetailDTO.length} vận động
                  viên
                </span>
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-gray-800 mb-1 group-hover:text-red-600 transition-colors duration-300">
                          {student?.name || "Tên không có sẵn"}
                        </h3>
                        <p className="text-xs text-gray-500 font-medium">
                          ID: {student?.idAccount || "N/A"}
                        </p>
                      </div>
                      {detail.medal && (
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span className="text-sm">
                          ...
                          <span className="font-medium text-gray-700">
                            {formatDateDMY(student?.birthDate) || "N/A"}
                          </span>
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-2 text-gray-600">
                        ...
                        <span className="text-sm">
                          ...
                          <span className="font-medium text-red-600">
                            {/* {student?.academicInfo?.beltLevel || "N/A"} */} Đỏ
                          </span>
                        </span>
                      </div>
                    </div>
