...
export default function TournamentDetailsSidebar({
  idTournament,
}: TournamentDetailsSidebarProps) {
  ...
  return (
    <div className="tournament-details-sidebar">
        ...
        {menuItems.map((item) => {
          ...
          return (
            <Link
              key={item.to}
              to={item.to}
              className={`tournament-details-sidebar__menu-item ${
                active ? "tournament-details-sidebar__menu-item--active" : ""
              }`}
            >
              <div className="content">
                <div className="main">
                  ...
                  <div className="text">
                    <p
                      className={`label ${
                        active ? "label--active" : "label--inactive"
                      }`}
                    >
                      {item.label}
                    </p>
                ...
                <ChevronRight
                  className={`chevron ${
                    active ? "chevron--active" : "chevron--inactive"
                  }`}
                />
              </div>
            </Link>
      ...
      <div className="tournament-details-sidebar__downloads">
        <p className="title">Tải xuống tài liệu</p>
        <div className="list">
          <button className="download-item">📄 Thể lệ giải đấu (PDF)</button>
